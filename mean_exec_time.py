...
def parse_and_average(filename):
    ...
    # FIXED REGEX: Targets the start of the line, grabs the stream count, and the execution time.
    # It completely ignores how the trailing verification characters (x, YES) are spaced out.
...
# ============================================================================
# PLOTTING INTERACTION GENERATOR
# ============================================================================
if plot_trends:
    ...
    # Save the isolated figure handle directly to disk FIRST
